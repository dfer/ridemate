function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        if(navigator.userAgent.indexOf("Opera")>0 || navigator.userAgent.indexOf("OPR")>0){
			...
			createjs.Sound.registerSound("../sounds/choose_ufo.ogg", "choose_chicken");
			...
			createjs.Sound.registerSound("../sounds/reveal_alien.ogg", "reveal_alien");
		}else{
			...
			createjs.Sound.registerSound("../sounds/choose_ufo.mp3", "choose_chicken");
			...
			createjs.Sound.registerSound("../sounds/reveal_alien.mp3", "reveal_alien");
		}
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("money_but","../sprites/but_money_bg.png");
