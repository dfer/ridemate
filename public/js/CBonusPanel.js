function CBonusPanel(){
    ...
    this._init = function(){        
        ...
        _oMaskAlien.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(110, 390, 800,240);
        ...
        _aAlienSprites[0].x = 110;
        _aAlienSprites[0].y = CANVAS_HEIGHT - 85;
        ...
        _aAlienSprites[1].x = 400;
        _aAlienSprites[1].y = CANVAS_HEIGHT - 85;
        ...
        _aAlienSprites[2].x = 700;
        _aAlienSprites[2].y = CANVAS_HEIGHT - 85;
    ...
    this.show = function(iNumUfo){
        ...
        switch(iNumUfo){
            case 3:{
                    _aBonusValue = new Array(50,500,2000);
                    break;
            }
            case 4:{
                    _aBonusValue = new Array(500,2000,5000);
                    break;
            }
            case 5:{
                    _aBonusValue = new Array(1000,5000,10000);
                    break;
            }
            default:{
                    _aBonusValue = new Array(50,500,2000);
    ...
    this._onUfoReleased = function(event,oData){
		...
		trace("s_aAlienOccurence["+iRandAlien+"]: "+s_aAlienOccurence[iRandAlien]);
    ...
    this.playUfoLayAnim = function(iIndex,iRandAlien){
        ...
        //var oParent = this;
        //setTimeout(function(){oParent.layAlien(iIndex);}, 2500);
		this.layAlien(iIndex);
    };
    
    this.layAlien = function(iIndex){
        //_aUfos[iIndex].gotoAndStop(5);
        
        _oAlien.x = _aUfos[iIndex].x ;
        var oParent = this;
        createjs.Tween.get(_oAlien).to({y:580}, 300).call(function(){oParent.endBonus();});  
