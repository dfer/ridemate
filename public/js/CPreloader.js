function CPreloader(){
    ...
    this.attachSprites = function(){
       ...
       _oPreloaderBar.x = 270;
       _oPreloaderBar.y = CANVAS_HEIGHT - 171;
       ...
       _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(271, CANVAS_HEIGHT - 170, 1,30);
       _oContainer.addChild(_oMaskPreloader);
       
       _oProgressBar.mask = _oMaskPreloader;
       
       _oLoadingText = new createjs.Text("","24px walibi0615bold", "#fff");
       _oLoadingText.x = CANVAS_WIDTH/2;
       _oLoadingText.y = CANVAS_HEIGHT - 148;
    ...
    this.refreshLoader = function(iPerc){
        ...
        _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(271, CANVAS_HEIGHT - 170, iNewMaskWidth,30);
    };
